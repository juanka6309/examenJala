...
namespace AssessmentTest
{
    ...
    public class ProviderTest
    {
        ...
        public void TestCommaSeparator()
        {
            ...
            CollectionAssert.AreEqual(expectedElements, provider.ProcessData(source,"1").ToList());
        }
        ...
        public void TestPipeSeparator()
        {
            ...
            IElementsProvider<string> provider = new StringProvider();
            string [] expectedElements = {"a", "b", "c", "d", "e"};
            CollectionAssert.AreEqual(expectedElements, provider.ProcessData(source, "2").ToList());
        }
        ...
        public void TestSpaceSeparator()
        {
            ...
            IElementsProvider<string> provider = new StringProvider();
            string [] expectedElements = {"a", "b", "c", "d", "e"};
            CollectionAssert.AreEqual(expectedElements, provider.ProcessData(source, "3").ToList());
        }
    }
}
